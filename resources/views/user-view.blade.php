...
@section('content')
    <div class="container">
        ...
        @elseif(Auth::user()->privilege == 99)
                                    ...
                                    @foreach($penduduks as $penduduk)
                                        <tr>
                                            ...
                                            <td th style="text-align: center">
                                                ...
                                                <a href="{{ url('/home/upload') }}/{{ $penduduk->id }}" type="file" class="btn btn-primary btn-sm">Upload</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
            ...
            <!-- Modal Upload File-->
            <div class="modal fade" id="modalUpload" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
        @endif
